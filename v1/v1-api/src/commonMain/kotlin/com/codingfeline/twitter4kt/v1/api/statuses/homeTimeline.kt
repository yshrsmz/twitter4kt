...
/**
 * Get's the authenticated user's home timeline.  This will return the full 280 characters
 * of a tweet in the fullText field rather than the text field
 *
 * This is rate limited.
 *
 * [Twitter API reference](https://developer.twitter.com/en/docs/twitter-api/v1/tweets/timelines/api-reference/get-statuses-home_timeline)
 *
